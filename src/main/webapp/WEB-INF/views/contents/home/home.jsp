...
<div class="container" style="margin-top: 50px">
    <header class="d-flex flex-wrap justify-content-center py-3 mb-4 border-bottom">
        ...
        <ul class="nav nav-pills">
            ...
            <li class="nav-item"><a href="/code/list" class="nav-link">코드 관리</a></li>
            <li class="nav-item"><a href="/" class="nav-link">상품페이지</a></li>
    ...
    <main>
        <c:forEach var="item" items="${category}">
            <a href="#" onclick="getItems(this);" data-ctNm="${item.codeValue}">${item.codeNm}</a>
        </c:forEach>
    </main>
</div>
<div class="container">
